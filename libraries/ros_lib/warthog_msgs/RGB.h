#ifndef _ROS_warthog_msgs_RGB_h
#define _ROS_warthog_msgs_RGB_h
...
namespace warthog_msgs
{
  ...
  class RGB : public ros::Msg
  {
    ...
    const char * getType(){ return "warthog_msgs/RGB"; };
    const char * getMD5(){ return "fc84fca2ee69069d6d5c4147f9b2e33a"; };
